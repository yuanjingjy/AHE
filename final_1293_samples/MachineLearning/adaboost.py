...
#testArr,testLabelArr=loadDataSet('testset.txt');
#prediction40=adaClassify(testArr,classifierArray);

#errArr=mat(ones((22,1)));
#print (errArr[prediction40!=mat(testLabelArr).T].sum())